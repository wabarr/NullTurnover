#' Test for pulses using using Foote Rates, using ultrametric trees simulated using phytools::pbtree()
...
#' 
DEPRECATDdetectPulses <- function(myTree, criterion = 1.5, desiredBinNumber = 10, plotTree=FALSE, plotRates = FALSE, returnRatePlot = FALSE) {
  require(phytools)
  require(paleotree)
